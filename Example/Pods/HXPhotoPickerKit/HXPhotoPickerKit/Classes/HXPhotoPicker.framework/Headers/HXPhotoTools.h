...
+ (void)savePhotoToCustomAlbumWithName:(NSString * _Nullable)albumName
                              ...
                              complete:(void (^ _Nullable)(HXPhotoModel * _Nullable model, BOOL success))complete;
+ (void)savePhotoToCustomAlbumWithName:(NSString * _Nullable)albumName
                             photoName:(NSString * _Nullable)photoName
                                 photo:(UIImage * _Nullable)photo
                              location:(CLLocation * _Nullable)location
                              complete:(void (^ _Nullable)(HXPhotoModel * _Nullable model, BOOL success))complete;
+ (void)savePhotoToCustomAlbumWithName:(NSString * _Nullable)albumName
                                 photoData:(NSData * _Nullable)photoData
                              location:(CLLocation * _Nullable)location;
+ (void)savePhotoToCustomAlbumWithName:(NSString * _Nullable)albumName
                                 photoData:(NSData * _Nullable)photoData
                              location:(CLLocation * _Nullable)location
...
+ (NSData * _Nullable)compressImageDataIfNeeded:(NSData * _Nullable)imgData;
+ (NSData * _Nullable)compressImageData:(NSData * _Nullable)imageData fitSize:(CGSize)targetSize maxBytes:(double)maxBytes minBytes:(double)minBytes toJPG:(BOOL)isToJPG;
@end
