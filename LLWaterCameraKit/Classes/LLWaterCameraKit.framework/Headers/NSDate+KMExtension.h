...
@property (nonatomic, readonly) NSDate *beginningOfToday; ///The beginning of today
@property (nonatomic, readonly) NSDate *endOfToday; ///The ending of today
@property (nonatomic, readonly) NSDate *beginningOfWeek; ///The beginning of today
@property (nonatomic, readonly) NSDate *endOfWeek; ///The ending of today
@property (nonatomic, readonly) NSDate *beginningOfMonth; ///The beginning of month
@property (nonatomic, readonly) NSDate *endOfMonth; ///The ending of month
...
- (BOOL)sameDayWithDate:(NSDate *_Nullable)date;
- (BOOL)earlierThanDate:(NSDate *_Nullable)anotherDate;
- (BOOL)laterThanDate:(NSDate *_Nullable)anotherDate;
- (BOOL)equalToDate:(NSDate *_Nullable)anotherDate;
...
- (NSString *)stringWithShanghaiTimeZoneAndUSPOSIXFormat:(NSString *)format;
/**
 Returns a formatted string representing this date.
 see http://www.unicode.org/reports/tr35/tr35-31/tr35-dates.html#Date_Format_Patterns
 for format description.
...
+ (nullable NSDate *)dateWithShanghaiTimeZoneAndUSPOSIXFormat:(NSString *)format dateString:(NSString *)dateString;
@end
