//
//  KMAVAssetExportSession.h
//
// This file is part of the KMAVAssetExportSession package.
//
...
@protocol KMAVAssetExportSessionDelegate;


/**
 * An `KMAVAssetExportSession` object transcodes the contents of an AVAsset source object to create an output
...
@interface KMAVAssetExportSession : NSObject

@property (nonatomic, weak) id<KMAVAssetExportSessionDelegate> delegate;
...
@protocol KMAVAssetExportSessionDelegate <NSObject>

- (void)exportSession:(KMAVAssetExportSession *)exportSession renderFrame:(CVPixelBufferRef)pixelBuffer withPresentationTime:(CMTime)presentationTime toBuffer:(CVPixelBufferRef)renderBuffer;
