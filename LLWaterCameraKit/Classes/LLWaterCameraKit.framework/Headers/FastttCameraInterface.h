...
@property (nonatomic, assign)FastttCameraLensType cameraLensType;
@property (nonatomic)BOOL enableVideoLayerAndVideoCaptureMirroredForFrontPosition; //设置前置是否镜像
@property (nonatomic)BOOL enableVideoCaptureMirroredForFrontPosition; //设置前置是否镜像
...
@optional
- (void)cameraController:(id<FastttCameraInterface>)cameraController cameraPositionDidChangeTo:(FastttCameraDevice)postionType;
- (void)cameraController:(id<FastttCameraInterface>)cameraController cameraLensModeDidChangeTo:(FastttCameraLensType)lensType;
/**
...
- (void)userDeniedAudioPermissionsForCameraController:(id<FastttCameraInterface>)cameraController;
- (void)cameraController:(id<FastttCameraInterface>)cameraController didRecognizeQRCodeString:(NSString *)qrCodeString;

- (void)cameraSessionDidStartRunningForCameraController:(id<FastttCameraInterface>)cameraController;
- (void)cameraSessionDidStopRunningForCameraController:(id<FastttCameraInterface>)cameraController;
@end
