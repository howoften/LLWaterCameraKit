...
@property (nonatomic, assign, readonly)BOOL isWideAngleDevice;
@property (nonatomic, assign)float wideAngleMaxZoomFactor;
/**
...
+ (AVCaptureDevice *)cameraDeviceWithoutResetVideoZoomFactor:(FastttCameraDevice)cameraDevice;
/**
